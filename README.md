...
1. ในการเรียกใช้บริการ ผู้ใช้ต้องติดตั้ง module ทั้งหมดใน pubspec.yaml โดยเปิด terminal และใช้คำสั่ง
```bash
flutter pub get
```
2. ในการเรียกใช้ api ผู้ใช้ต้องกรอก api โดยเราได้เตรียม apikey ไว้ให้เรียบร้อยแล้ว ผู้ใช้สามารถเข้าถึงได้จากไฟล์ต่อไปนี้
https://drive.google.com/file/d/1qbuAgKhOuPvVhwp2VZllCMPwZzSQ3HdY/view?usp=sharing

3. นำ api ทั้ง 2 api จากไฟล์ข้างต้นมากรอกในไฟล์ .env ให้เสร็จสิ้น
4. ทำการ run แอปพลิเคชัน (โดยแนะนำให้ใช้มือถือจริงในการ run แอพพลิเคชัน เนื่องจากต้องใช้ geolocation และ gps จากอุปกรณ์มือถือ)
